...
known = {
    ...
    # Mueble
    'sofás': 'Mueble', 'almohada': 'Mueble', 'almohadas': 'Mueble', 'pillow': 'Mueble', 
    'pillows': 'Mueble', 'cajón': 'Mueble', 'cajones': 'Mueble', 'drawer': 'Mueble', 'drawers': 'Mueble', 
    'puff': 'Mueble', 'zapatero': 'Mueble', 'zapateros': 'Mueble', 'shoerack': 'Mueble', 'shoeracks': 'Mueble',
    'sofá': 'Mueble','mesa': 'Mueble','mesas': 'Mueble','silla': 'Mueble','sillas': 'Mueble','sillón': 'Mueble',
    'sillones': 'Mueble','cama': 'Mueble','camas': 'Mueble','alfombra': 'Mueble','alfombras': 'Mueble','jarrón': 'Mueble',
    'jarrones': 'Mueble','estantería': 'Mueble','estanterías': 'Mueble', 'escritorio': 'Mueble','escritorios': 'Mueble',
    'colchón': 'Mueble','colchones': 'Mueble','mueble': 'Mueble','muebles': 'Mueble', 'taburete': 'Mueble',
    'taburetes': 'Mueble','espejo': 'Mueble','espejos': 'Mueble','armario': 'Mueble','armarios': 'Mueble',
    'perchero': 'Mueble','percheros': 'Mueble','somier': 'Mueble','somieres': 'Mueble','lámpara': 'Mueble',
    'lámparas': 'Mueble','butaca': 'Mueble','butacas': 'Mueble','cambiador': 'Mueble','cambiadores': 'Mueble',
    'chaiselongue': 'Mueble','chaiselongues': 'Mueble','cojín': 'Mueble','cojines': 'Mueble','cuadro': 'Mueble',
    'cuadros': 'Mueble','jarra': 'Mueble','jarras': 'Mueble','colgador': 'Mueble','colgadores': 'Mueble','asiento': 'Mueble',
    'asientos': 'Mueble','reloj': 'Mueble','relojes': 'Mueble','papel': 'Mueble','papeles': 'Mueble','cesto': 'Mueble','cestos': 'Mueble',
    'cesta': 'Mueble','cestas': 'Mueble', 'sofas': 'Mueble','sofa': 'Mueble','couch': 'Mueble','chairs': 'Mueble',
    'armchair': 'Mueble','armchairs': 'Mueble','rug': 'Mueble','carpets': 'Mueble','vase': 'Mueble','vases': 'Mueble','shelving': 'Mueble','shelves': 'Mueble','bookstore': 'Mueble',
    'libraries': 'Mueble','desk': 'Mueble','desks': 'Mueble','mattress': 'Mueble','mattresses': 'Mueble','piece of furniture': 'Mueble',
    'furniture': 'Mueble','library': 'Mueble','run': 'Mueble','letter': 'Mueble','small table': 'Mueble','table': 'Mueble','meson': 'Mueble',
    'mesons': 'Mueble','stool': 'Mueble','stools': 'Mueble','mirror': 'Mueble','mirrors': 'Mueble','closet': 'Mueble','wardrove': 'Mueble',
    'banks': 'Mueble','organizer': 'Mueble','organizers': 'Mueble','coat rack': 'Mueble','coat hangers': 'Mueble','dresser': 'Mueble',
    'players': 'Mueble','lamp': 'Mueble','lamps': 'Mueble','seat': 'Mueble','seats': 'Mueble','changer': 'Mueble','changers': 'Mueble',
    'cushion': 'Mueble','cushions': 'Mueble','picture': 'Mueble','jug': 'Mueble','jugs': 'Mueble','hanger': 'Mueble','hangers': 'Mueble',
    'seating': 'Mueble','watch': 'Mueble','watches': 'Mueble','flowerpot': 'Mueble','pots': 'Mueble','deck chair': 'Mueble','loungers': 'Mueble',
    'paper': 'Mueble','papers': 'Mueble','dough': 'Mueble','baskets': 'Mueble','the road': 'Mueble','cradle': 'Mueble','cribs': 'Mueble',
    'trone': 'Mueble','screen': 'Mueble','biples': 'Mueble', 'chair': 'Mueble', 'chairs': 'Mueble'
}
